...
const ENTITY_CASES=[
  ...
  {name:"EquipmentDefinitionVersion",factory:TD.createEquipmentDefinitionVersion,input:{id:"edv1",version:1,canonical_name:"Barbell",family:"FREE_WEIGHT",subtype:"OLYMPIC_BARBELL",status:"ACTIVE"},expectedKeys:["id","version","canonical_name","family","subtype","machine_functional_subtype","default_capability_schema","status"]},
  ...
  {name:"CapabilityPredicate",factory:TD.createCapabilityPredicate,input:{namespace:"RACK",operator:"EQ",value:"SQUAT_HEIGHT"},expectedKeys:["namespace","operator","value"]},
